          ...
          <div className="text-center max-w-4xl mx-auto px-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
                ...
                <Link 
                  ...
                  className="btn-secondary text-base md:text-lg px-6 md:px-8 py-3 md:py-4 rounded-xl border-2 hover:bg-gray-50 transition-all duration-300"
                >
                  <span className="mr-2">📱</span>
                  iPhone Guides
                </Link>
        ...
        <div className="container-custom px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
              <Link 
                href="/contact"
                className="bg-white text-blue-600 hover:bg-gray-100 text-base md:text-lg px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                <span className="mr-2">💬</span>
                Contact Us
              </Link>
              <Link 
                href="/troubleshooting"
                className="border-2 border-white text-white hover:bg-white hover:text-blue-600 text-base md:text-lg px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold transition-all duration-300"
              >
                <span className="mr-2">🔍</span>
                Browse All Issues
              </Link>
