  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-blue-100/30 to-cyan-100/30 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 text-blue-800 text-sm font-semibold mb-8"
          >
            <span className="w-2 h-2 bg-blue-600 rounded-full mr-2 animate-pulse"></span>
            Expert iPhone & iOS Troubleshooting
          </motion.div>
          ...
          >
            Comprehensive step-by-step guides to solve iPhone problems, battery issues, 
            connectivity troubles, and more. Get your device working perfectly again.
          </motion.p>
          ...
          >
            <Link href="/troubleshooting/iphone" className="btn-primary text-lg px-8 py-4">
          ...
          >
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-purple-600 mb-2">Free</div>
